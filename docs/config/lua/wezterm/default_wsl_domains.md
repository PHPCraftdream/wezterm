...
!!! note
    ...
    evaluated, including on every reload. If you don't need a live answer, consider setting
    `wsl_domains` once with an explicit, hand-written list instead of calling
    this function from your config.
